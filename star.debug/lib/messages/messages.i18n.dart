...
/// ```
	String delete_snapshot_prompt(id, ts) => """Do you want to delete snapshot of dish $id for $ts?""";
/// ```dart
/// "Do you want to delete ALL snapshot of dish $id but last?"
/// ```
	String delete_all_snapshots_but_last_prompt(id) => """Do you want to delete ALL snapshot of dish $id but last?""";
/// ```dart
...
/// ```
	String get delete_all_dished_prompt => """Do you want to delete data for ALL dishes?""";
}
...
/// ```
	String get auto_store_dish_log_sub => """Store snapshots automatically from Starlink Live in My Starlinks""";
}
...
/// ```
	String get valkyrie_check_sub => """Checks whether router BSSID (wireless MAC address) is found in databases from Valkyrie.""";
/// ```dart
/// "Found"
/// ```
...
/// ```
	String setup_ssid_pass(ssid, pass) => """You have selected network name "$ssid" and password "$pass". Confirm?""";
/// ```dart
/// "You have selected to leave default network name "STARLINK" and no password. Confirm?"
/// ```
	String get setup_default => """You have selected to leave default network name "STARLINK" and no password. Confirm?""";
/// ```dart
/// "You have selected to enable bypass mode. Router will be not accessible in this mode until next hardware reset. Confirm?"
/// ```
	String get setup_bypass => """You have selected to enable bypass mode. Router will be not accessible in this mode until next hardware reset. Confirm?""";
/// ```dart
/// "8 chars or more"
/// ```
...
""";
	...
	DishReadyStatesGrpcMessages get DishReadyStates => DishReadyStatesGrpcMessages(this);
	DishConfigGrpcMessages get DishConfig => DishConfigGrpcMessages(this);
	DishObstructionStatsGrpcMessages get DishObstructionStats => DishObstructionStatsGrpcMessages(this);
	DishGetStatusGrpcMessages get DishGetStatus => DishGetStatusGrpcMessages(this);
	AlignmentStatsGrpcMessages get AlignmentStats => AlignmentStatsGrpcMessages(this);
	...
	BasicServiceSetGrpcMessages get BasicServiceSet => BasicServiceSetGrpcMessages(this);
	...
	WifiGetStatusGrpcMessages get WifiGetStatus => WifiGetStatusGrpcMessages(this);
}
...
/// """
/// ```
	String get cause__hint => """The reason why the dish is offline. The possible options are:
...
/// ```
	String get avg_prolonged_obstruction_duration_s => """Average prolonged obstruction duration""";
/// ```dart
/// "Average prolonged obstruction interval"
/// ```
	String get avg_prolonged_obstruction_interval_s => """Average prolonged obstruction interval""";
/// ```dart
/// "Average prolonged obstruction valid"
/// ```
	String get avg_prolonged_obstruction_valid => """Average prolonged obstruction valid""";
/// ```dart
/// "Time obstructed"
/// ```
...
"
/// ```
	String get uptime_s__hint => """Time the dish is running since the last reboot.
""";
/// ```dart
/// "Seconds to first non-empty slot"
/// ```
	String get seconds_to_first_nonempty_slot => """Seconds to first non-empty slot""";
/// ```dart
/// "PoP ping drop rate"
/// ```
...
/// ```
	String get avg_prolonged_obstruction_duration_s => """avg_prolonged_obstruction_duration_s""";
/// ```dart
/// "avg_prolonged_obstruction_interval_s"
/// ```
	String get avg_prolonged_obstruction_interval_s => """avg_prolonged_obstruction_interval_s""";
/// ```dart
/// "avg_prolonged_obstruction_valid"
/// ```
	String get avg_prolonged_obstruction_valid => """avg_prolonged_obstruction_valid""";
/// ```dart
/// "time_obstructed"
/// ```
...
/// ```
	String get boresight_elevation_deg => """Panel boresight Elevation agngle, deg""";
/// ```dart
/// "Ethernet speed"
/// ```
...
/// ```
	String get desired_boresight_azimuth_deg => """Desired boresight Azimuth angle, deg""";
/// ```dart
/// "Desired boresight Elevation agngle, deg"
/// ```
	String get desired_boresight_elevation_deg => """Desired boresight Elevation agngle, deg""";
}
...
/// ```
	String get steer_req_fail_and_dissoc_last_1h => """steer_req_fail_and_dissoc_last_1h""";
/// ```dart
/// "steer_state"
/// ```
...
/// ```
	String get est_tx_rate_mbps_from_controller => """est_tx_rate_mbps_from_controller""";
/// ```dart
/// "est_rx_rate_mbps_from_controller"
/// ```
	String get est_rx_rate_mbps_from_controller => """est_rx_rate_mbps_from_controller""";
/// ```dart
/// "hardware_version"
/// ```
...
Map<String, String> get messagesMap => {
	...
	"""my.delete_all_dished_prompt""": """Do you want to delete data for ALL dishes?""",
	"""about.about""": """About""",
...
""",
	...
	"""settings.auto_store_dish_log_sub""": """Store snapshots automatically from Starlink Live in My Starlinks""",
...
""",
	...
	"""wifi.setup_default""": """You have selected to leave default network name "STARLINK" and no password. Confirm?""",
	"""wifi.setup_bypass""": """You have selected to enable bypass mode. Router will be not accessible in this mode until next hardware reset. Confirm?""",
...
""",
	...
	"""grpc.DeviceInfo.software_partitions_equal""": """Software partitions equal""",
	...
	"""grpc.DeviceInfo.manufactured_version""": """Software version (manufactured)""",
	...
	"""grpc.DishOutage.cause__hint""": """The reason why the dish is offline. The possible options are:
...
""",
	...
	"""grpc.DishGpsStats.no_sats_after_ttff""": """No GPS satellites after first fix""",
	...
	"""grpc.DishConfig.location_request_mode__hint""": """The possible options are:
- **NONE** - Starlink does not expose it's location to the local network.
- **LOCAL** - Starlink exposes it's location to the local network via DHCP and dish API.
...
""",
	...
	"""grpc.DishConfig.power_save_start_minutes""": """Power save start minutes""",
	"""grpc.DishConfig.power_save_duration_minutes""": """Power save duration minutes""",
	"""grpc.DishConfig.power_save_mode""": """Power save mode""",
	"""grpc.DishObstructionStats.fraction_obstructed""": """Fraction obstructed""",
	"""grpc.DishObstructionStats.valid_s""": """Time valid""",
	"""grpc.DishObstructionStats.currently_obstructed""": """Currently obstructed""",
	"""grpc.DishObstructionStats.avg_prolonged_obstruction_duration_s""": """Average prolonged obstruction duration""",
	"""grpc.DishObstructionStats.avg_prolonged_obstruction_interval_s""": """Average prolonged obstruction interval""",
	"""grpc.DishObstructionStats.avg_prolonged_obstruction_valid""": """Average prolonged obstruction valid""",
	...
	"""grpc.DishGetStatus.uptime_s__hint""": """Time the dish is running since the last reboot.
""",
	"""grpc.DishGetStatus.seconds_to_first_nonempty_slot""": """Seconds to first non-empty slot""",
	...
	"""grpc.DishGetStatus.avg_prolonged_obstruction_duration_s""": """avg_prolonged_obstruction_duration_s""",
	"""grpc.DishGetStatus.avg_prolonged_obstruction_interval_s""": """avg_prolonged_obstruction_interval_s""",
	"""grpc.DishGetStatus.avg_prolonged_obstruction_valid""": """avg_prolonged_obstruction_valid""",
	...
	"""grpc.DishGetStatus.boresight_azimuth_deg""": """Panel boresight Azimuth angle, deg""",
	"""grpc.DishGetStatus.boresight_elevation_deg""": """Panel boresight Elevation agngle, deg""",
...
- OTHER_OPTIONS
""",
	"""grpc.DishGetStatus.is_snr_above_noise_floor""": """SNR above noise floor""",
...
""",
	...
	"""grpc.AlignmentStats.boresight_azimuth_deg""": """Panel boresight Azimuth angle, deg""",
	"""grpc.AlignmentStats.boresight_elevation_deg""": """Panel boresight Elevation agngle, deg""",
	"""grpc.AlignmentStats.attitude_estimation_state""": """Attitude estimation state""",
	"""grpc.AlignmentStats.attitude_uncertainty_deg""": """Attitude uncertainty, deg""",
	"""grpc.AlignmentStats.desired_boresight_azimuth_deg""": """Desired boresight Azimuth angle, deg""",
	"""grpc.AlignmentStats.desired_boresight_elevation_deg""": """Desired boresight Elevation agngle, deg""",
...
""",
	...
	"""grpc.WifiConfig.disable_automated_speedtests""": """disable_automated_speedtests""",
	...
	"""grpc.WifiConfig.tx_power_level_5ghz_high""": """tx_power_level_5ghz_high""",
	...
	"""grpc.WifiClient.steer_req_success_last_1h""": """steer_req_success_last_1h""",
	"""grpc.WifiClient.steer_req_fail_last_1h""": """steer_req_fail_last_1h""",
	"""grpc.WifiClient.steer_req_fail_and_dissoc_last_1h""": """steer_req_fail_and_dissoc_last_1h""",
	...
	"""grpc.WifiClient.est_tx_rate_mbps_from_controller""": """est_tx_rate_mbps_from_controller""",
	"""grpc.WifiClient.est_rx_rate_mbps_from_controller""": """est_rx_rate_mbps_from_controller""",
	...
	"""grpc.WifiGetStatus.dish_ping_drop_rate_5m""": """Dish ping drop rate, 5m""",
